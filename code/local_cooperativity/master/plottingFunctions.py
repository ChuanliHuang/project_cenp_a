...
if __name__ == '__main__':
    with open("/Users/kikawaryoku/PycharmProjects/project_cenp_a/code/cooperativity/master/parameters.yaml") as f:
        config = yaml.load(f, Loader=yaml.Loader)
        config = bunchify(config)
    file_name = '/Users/kikawaryoku/PycharmProjects/project_cenp_a/code/cooperativity/master/states/lineage0.csv'

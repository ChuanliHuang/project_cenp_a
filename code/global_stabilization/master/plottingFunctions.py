...
if __name__ == '__main__':
    with open("/Users/kikawaryoku/PycharmProjects/project_cenp_a/code/global_stabilization/master/parameters.yaml") as f:
        config = yaml.load(f, Loader=yaml.Loader)
        config = bunchify(config)
    file_name = '/Users/kikawaryoku/PycharmProjects/project_cenp_a/code/global_stabilization/master/states/lineage0.csv'

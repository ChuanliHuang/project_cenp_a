...
if __name__ == '__main__':
    ...
    for lineage in range(config.simulation.lineages_to_simulate):
        ...
        for generation in range(config.simulation.lineage.generations_to_simulate):
            ...
            state = dilute(state, config.simulation.lineage.generation.mu, config.simulation.lineage.generation.sigma,
                           config.simulation.lineage.generation.loss_rate,
                           config.simulation.lineage.generation.dist_bias)
            # observe
            states.append(state)

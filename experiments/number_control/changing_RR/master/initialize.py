...
def initialize_parameters_specific_folders(s=3, rr=3, af=1):
    ...
    2. copy linear_grey.py simulate.py parameters.yaml to each folder
    ...
    # linear_grey.py pathname
    model_pathname = dir_path + '/' + 'linear_grey.py'
    ...
    for parameter_combo in parameter_combos:
        ...
        # copy linear_grey.py simulate.py parameters.yaml to each folder
...
initialize_parameters_specific_folders(af=(0.1, 1, 10))
